...
image_path = "images/" + input("Image name: ")
...
for i in range(detected_objects.shape[2]):
    ...
    if confidence > min_confidence:
        ...
        cv2.putText(image, prediction, (upper_left_x, upper_left_y - 15 if upper_left_y > 30 else upper_left_y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.6, colors[class_index], 2)
